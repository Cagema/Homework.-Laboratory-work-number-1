...
TEST_F(ClassDeclaration, PushBack_onInt_for_1) {
    objInt.push_back(1);
    objInt.push_back(2);
    objInt.push_back(3);
...
TEST_F(ClassDeclaration, PushBack_onInt_for_2) {
    objInt.push_back(1);
    objInt.push_back(2);
    objInt.push_back(3);
...
TEST_F(ClassDeclaration, PushBack_onInt_for_3) {
    objInt.push_back(1);
    objInt.push_back(2);
    objInt.push_back(3);
...
TEST_F(ClassDeclaration, PushFront_onDouble_for_1) {
...
TEST_F(ClassDeclaration, PushFront_onDouble_for_2) {
    objDouble.push_front(1.1);
    objDouble.push_front(2.2);
    objDouble.push_front(3.3);
...
TEST_F(ClassDeclaration, PushFront_onDouble_for_3) {
    objDouble.push_front(1.1);
    objDouble.push_front(2.2);
    objDouble.push_front(3.3);
...
TEST_F(ClassDeclaration, PopBack_onString_for_1) {
...
TEST_F(ClassDeclaration, PopBack_onString_for_2) {
    objString.push_back("str1");
    objString.push_back("str2");
    objString.push_back("str3");
...
TEST_F(ClassDeclaration, PopFront_onChar_for_1) {
    objChar.push_back('C');
    objChar.push_back('a');
    objChar.push_back('g');
...
TEST_F(ClassDeclaration, PopFront_onChar_for_2) {
    objChar.push_back('C');
    objChar.push_back('a');
    objChar.push_back('g');
...
TEST_F(ClassDeclaration, Insert_onDoub_NormArg_for_1) {
...
TEST_F(ClassDeclaration, Insert_onDoub_NormArg_for_2) {
    objDouble.push_back(1.1);
    objDouble.push_back(2.2);
...
TEST_F(ClassDeclaration, Insert_onDoub_NormArg_for_3) {
    objDouble.push_back(1.1);
    objDouble.push_back(2.2);
...
TEST_F(ClassDeclaration, Remove_onChar_NormArg_for_1) {
    objChar.push_back('C');
    objChar.push_back('a');
    objChar.push_back('g');
...
TEST_F(ClassDeclaration, Remove_onChar_NormArg_for_2) {
    objChar.push_back('C');
    objChar.push_back('a');
    objChar.push_back('g');
...
TEST_F(ClassDeclaration, test_GetSize){
